...
| la station vue du dehors (les planches de l'approche, `assets-ia.md` §26) | `docs/reference/station-reference.png` — à désigner : la planche `approche-3` réussie, la première à générer |
