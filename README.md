...
## État — version 0.21.405, une run jouable de bout en bout

Le jeu tourne dans le navigateur, sur ordinateur, tablette et téléphone.
**405 livraisons consignées entre le 08/08/2026 et le 01/09/2026** — le journal
...
```bash
pnpm test        # 751 tests dans 68 fichiers, ~22 s
pnpm type-check
pnpm build
```
