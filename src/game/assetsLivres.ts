...
const NOMS: Record<string, string> = {
  ...
  'chaudiere-atlas.webp': 'Chaleurs : la chaudière (rampe, bout, joint, brûleur, compacte, sol chauffé) et le surchauffeur (serpentin, collecteur, spirale)',
...
export function rubriqueDe(url: string): string {
  ...
  if (/^(wall|paroi|phile|phobe|conduite|chaudiere|grille|sponge)/.test(f))
