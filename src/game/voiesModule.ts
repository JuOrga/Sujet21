...
export function dessinMiniCarteSVG(
  ...
  const NOMS_HALTE: Record<string, string> = {
    ...
    minijeu: 'un mini-jeu — le couperet (laisser dépasser du trait ce que la lame doit trancher), le palet (glisser en glace jusqu’au centre) ou le flipper (être la bille)',
  }
