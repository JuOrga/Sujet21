...
export const FICHES_MATERIAUX: Record<number, Fiche> = {
  ...
  [MAT_VIDE]: {
    ...
    resume: 'Le plancher manque : le dehors aspire ce qui s’y attarde.',
    lignes: [
      { cle: 'EAU', txt: 'passe dessus — mais 3 s au-dessus, le vide la prend et l’aspire : game over.' },
      { cle: 'GLACE', txt: 'pareil : le vide l’emporte aussi.' },
      { cle: 'VAPEUR', txt: 'pareil : le nuage y est avalé.' },
      { cle: 'LASER', txt: 'traverse.' },
      { cle: '·', txt: 'Compte le CENTRE du corps : le frôler ne coûte rien, y rester oui. Ressortir à temps fait redescendre le compte (deux fois plus vite).' },
      { cle: '·', txt: 'Une fenêtre sur les étoiles, sans monture. Prend toutes les formes.' },
