...
export const DELIVERIES: Delivery[] = [
  {
    ...
    title: 'LE PREMIER CHARGEMENT : un mot de chargement dès le premier pixel, le rendu compilé en coulisse, et la veille qui ne recouvre plus un jeu qui tourne',
    notes: [
      ...
      'LE MOT DU CHARGEMENT : un cartouche en bas de l’écran, porté par le document lui-même (visible sans JavaScript, couleurs littérales comme le panneau de panne), qui dit où on en est — « le fichier arrive… », « le module s’ouvre… », « le rendu se compile… » — et que la première image retire. main.ts lui raconte chaque étape (__sujet21Etape).',
