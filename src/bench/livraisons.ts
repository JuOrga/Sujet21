...
export const DELIVERIES: Delivery[] = [
  ...
  },
  {
    ...
    notes: [
      'LA DEMANDE : « pour la cinématique d’introduction, j’aimerais que les premières images soient la planète vue de l’espace avec différentes images de plus en plus rapprochées de la station en orbite » — et des prompts qui gardent la station cohérente d’une image à l’autre.',
      'CE QUI CHANGE : six planches neuves en tête de L’OUVERTURE (cine/approche-1..6.webp) — la planète à anneau seule, son limbe et un point brillant, la station entière lisible comme la carte (arc de coque, hub Méduse, trois modules, nœud, observatoire à dôme, télescope amarré, mât solaire), l’arc et le hub au premier plan, le module Méduse et son hublot, le hublot plein cadre avec la lueur de la cuve derrière la vitre. Muettes toutes les six : la première réplique tombe sur la cuve, juste après le hublot. Côté son, le lit glacial (cuve-glaciale) dès la planète — dehors, c’est froid — la condensation sur la vitre du hublot, puis le lit tiède avec la cuve, comme avant. Six zooms enchaînés font un seul travelling ; la planche 3 panote pour parcourir la station. LE DÉPART, rejoué à chaque run, ne les reprend pas.',
      'COMMENT LA STATION TIENT : la section 26 d’assets-ia.md — un socle commun à chaque prompt (la fiche de la planète, de la station selon carteStation.json, de la lumière), la planche 3 générée en premier puis donnée en référence d’image aux suivantes. Elle devient docs/reference/station-reference.png : la station vue du dehors a maintenant une référence (charte §6). La planète est tranchée : la géante gazeuse à anneau qui réconcilie plafond-planete.webp et le prompt de l’observatoire — pas la Terre.',
      'CE QUE LA PREMIÈRE FOURNÉE A APPRIS : le générateur ignorait « not Earth » et « no sun in frame » — une Terre, un soleil, une lune, du texte peint sur la coque, un écran plat derrière le hublot. Les négatifs durcis sont dans la section, à garder tels quels.',
      'VÉRIFIÉ : les six planches passées par prepare.py — 1600×900, luminance de 0,03 à 0,18 (plafond 0,50), 0 % de pixels chauds, 20 à 234 Ko (plafond 260) ; le test de l’ouverture relit les treize planches ; le catalogue des images les attrape par le dossier. 1219 verts dans 114 fichiers, type-check à 0, build propre.',
    ],
  },
  {
