...
export const DELIVERIES: Delivery[] = [
  {
    ...
    notes: [
      ...
      'VÉRIFIÉ : 881 tests verts dans 77 fichiers (sept de plus), type-check à 0, build propre. À voir dans l’éditeur : une paroi, une cachette et une coque tournées, leurs huit poignées, un côté tiré.',
    ],
  },
  {
